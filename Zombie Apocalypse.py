...
gliding = False
attacking = False
title = pygame.image.load("/Users/aaavi/Downloads/Good_Title.png")
buttonDifficulty = pygame.image.load("/Users/aaavi/Downloads/Difficulty.png")
bg = pygame.image.load("/Users/aaavi/Downloads/graveyardtilesetnew/png/BG.png")
bg = pygame.transform.scale(bg, (750, 500))
deadbush = pygame.image.load("/Users/aaavi/Downloads/graveyardtilesetnew/png/Objects/DeadBush.png")
deadbush = pygame.transform.scale(deadbush, (50, 50))
skeleton = pygame.image.load("/Users/aaavi/Downloads/graveyardtilesetnew/png/Objects/Skeleton.png")
bush = pygame.image.load("/Users/aaavi/Downloads/graveyardtilesetnew/png/Objects/Bush (1).png")
bush = pygame.transform.scale(bush, (100, 50))
sign = pygame.image.load("/Users/aaavi/Downloads/graveyardtilesetnew/png/Objects/Sign.png")
sign = pygame.transform.scale(sign, (50, 50))
for i in range(0, 9):
    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Glide_00{i}.png")
    image = pygame.transform.scale(image, (95, 95))
    glideright.append(image)
    image = pygame.transform.flip(image, True, False)
    glideleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Run__00{i}.png")
    image = pygame.transform.scale(image, (75, 100))
    walkright.append(image)
    image = pygame.transform.flip(image, True, False)
    walkleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Jump__00{i}.png")
    image = pygame.transform.scale(image, (75, 100))
    jumpright.append(image)
    image = pygame.transform.flip(image, True, False)
    jumpleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Idle__00{i}.png")
    image = pygame.transform.scale(image, (48, 96))
    idleright.append(image)
    image = pygame.transform.flip(image, True, False)
    idleleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Slide__00{i}.png")
    image = pygame.transform.scale(image, (80, 80))
    slideright.append(image)
    image = pygame.transform.flip(image, True, False)
    slideleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Attack__00{i}.png")
    image = pygame.transform.scale(image, (105, 105))
    attackright.append(image)
    image = pygame.transform.flip(image, True, False)
    attackleft.append(image)

    image = pygame.image.load(f"/Users/aaavi/Zombie/png-3/Dead__00{i}.png")
    image = pygame.transform.scale(image, (105, 105))
    deadright.append(image)
    image = pygame.transform.flip(image, True, False)
    deadleft.append(image)
for i in range(1, 10):
    image = pygame.image.load(f"/Users/aaavi/Downloads/png-2/male/Walk ({i}).png")
...
for i in range(1, 8):
    image = pygame.image.load(f"/Users/aaavi/Downloads/png-2/male/Attack ({i}).png")
    image = pygame.transform.scale(image, (80, 100))
...
for i in range(1, 12):
    image = pygame.image.load(f"/Users/aaavi/Downloads/png-2/male/Dead ({i}).png")
